...
const events = [
  ...
  },
  {
    ...
    activities: [
      ...
      { time: "14:00", title: "Официальное поздравление", location: "Актовый зал", description: "Награждение Благодарственными письмами, Тайный Дед Мороз", fileUrl: "https://cdn.poehali.dev/files/тайный Дед Мороз.jpg", fileName: "Тайный Дед Мороз - правила" },
