...
const events = [
  {
    ...
    icon: "Sparkles",
    activities: [
      { time: "В течение дня", title: "Смотр оформления кабинетов", location: "Офис", description: "Оценка праздничного оформления всех кабинетов" },
      { time: "14:00", title: "Мастер-класс по созданию новогодних украшений", location: "Банкетный зал", description: "Создание оригинальных украшений из бересты своими руками. Результаты украсят офис!" }
    ]
  },
  {
    date: "23 декабря",
    ...
    icon: "PartyPopper",
    activities: [
      { time: "11:00", title: "Веселые старты", location: "Спортзал", description: "Соревнования: запуск бумажных снеговиков, эстафета с мандарином на ложке, метание бумажных снежков в корзину" }
    ]
  },
  {
    date: "24 декабря",
    ...
    icon: "Flame",
    activities: [
      { time: "10:00", title: "Корпоративный лекторий", location: "Конференц-зал", description: "Эксперт по психологии и личной эффективности расскажет о достижении целей, техниках управления временем и стрессоустойчивости" },
  ...
  },
  {
    ...
    icon: "Wand2",
    activities: [
      { time: "12:00", title: "Новогодний квест", location: "Офис", description: "Увлекательное командное приключение с загадками и сюрпризами" }
    ]
  },
  {
    date: "26 декабря",
    ...
    icon: "Gift",
    activities: [
      { time: "09:00", title: "Раздача подарков", location: "Вход", description: "Дед Мороз, Снегурочка раздают подарки" },
      { time: "11:00", title: "Официальное поздравление", location: "Актовый зал", description: "Награждение Благодарственными письмами, Тайный Дед Мороз" },
      { time: "13:00", title: "Новогодний огонек", location: "Банкетный зал", description: "Фуршет в костюмах, ребусы, загадки, поздравления от отделов" }
    ]
  },
  {
    date: "29 декабря",
