...
const events = [
  ...
  },
  {
    ...
    icon: "Flame",
    activities: [
      { time: "12:00", title: "Корпоративный лекторий", location: "аудитория 1.5", description: "Эксперт по психологии и личной эффективности расскажет о достижении целей, техниках управления временем и стрессоустойчивости" },
