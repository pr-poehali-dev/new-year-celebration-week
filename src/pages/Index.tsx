...
const events = [
  ...
  },
  {
    ...
    activities: [
      ...
      { time: "14:00", title: "Официальное поздравление", location: "Актовый зал", description: "Награждение Благодарственными письмами, Тайный Дед Мороз" },
      { time: "15:00-17:00", title: "Новогодний огонек", location: "Банкетный зал", description: "Фуршет в костюмах, ребусы, загадки, поздравления от отделов" }
    ]
  },
  {
    date: "29 декабря",
